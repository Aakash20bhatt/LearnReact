    ...
    return(
        <div className="flex flex-col items-center justify-center">
            ...
            <div 
                ...
                <table style={{ position: 'relative', height: filteredMovies.length * ITEM_HEIGHT, width:'100%'}}>
                    <thead className="bg-slate-300 h-12 rounded-lg sticky top-0" style={ {width:'100%'}}>
                    ...
                    <tbody style={{ width:'100%'}}>
                        {visibleMovies.map((movie, index) => {
                            ...
                            return (
                                <tr key={movie.id}  className="border-2 hover:bg-slate-100" style={{ position: 'absolute', top:10 ,width:'100%'}}>
