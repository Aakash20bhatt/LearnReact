        ...
        <>
            <div className="bg-cover bg-center flex items-center py-4 px-8">
                ...
                <div className="p-8">
                    ...
                    <div className="flex mt-4">
                        <div className="mr-4">
                            <sdivan className="text-xs font-bold">Director</span>
                            <p>{director[0]}</p>
                        </div>
                        <div className="mr-4">
                            <span className="text-xs font-bold">Producer</span>
                            <p>{producer[0]}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="cast py-4 px-8 mb-8">
                ...
                <div className="flex flex-wrap justify-evenly my-8 ">
                    {cast.map((item,index)=>{
                        return (
                            <div className="card my-4 flex flex-col hover:scale-105 duration-300 cursor-pointer relative rounded-[1rem] overflow-hidden" key={index}>
