...
export default function Banner(){
    ...
    return (
        <Link to={`${title.replace(/[:\s]+/g, '-').replace(/[^a-zA-Z0-9-_]/g, '')}/${movieID}`}>
            <div className="h-[75vh] bg-cover flex items-end cursor-pointer" style={{backgroundImage: `url(${bannerImage})` }}>
