...
let movies = [
    ...
    },
    {
      ...
      "overview": "Seventeen year old Tanya's plans for a carefree summer are derailed when her stressed-to-the-limit mom takes off for a wellness retreat and puts Tanya and her three siblings in the charge of a crotchety (and racist) old babysitter. The babysitter’s sudden death leaves the kids short on cash and reluctant to pull mom prematurely out of her much-needed R&R, so Tanya is forced to get a job. Posing as an adult, she gets a gig as the executive assistant at a fashion company and overnight is thrust into the world of adulthood and parenting.",
    ...
    },
    {
      ...
      "overview": "Three friends find themselves at an old temple located on the outskirts of the city. However, this temple harbours a terrifying legend: anyone who wishes to be ordained as a monk there is cursed.",
                    ...
                    {movies.map((movie)=>{
                        return (
                            <tr key={movie.id} className="border-2	hover:bg-slate-100"> 
                                ...
                                <td className="p-2">{movie.genre_ids[0]}</td>
                                <td className="text-rose-600 cursor-pointer p-2">
