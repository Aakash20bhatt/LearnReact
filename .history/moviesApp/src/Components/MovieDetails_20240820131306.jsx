    ...
    if(loader) return <h1>Loading...</h1>
        ...
        <>
            ...
            <div className="cast py-4 px-8 mb-8">
                <h2>Top Cast</h2>
                <div className="flex flex-wrap justify-evenly my-8 hover:scale-105 duration-300 cursor-pointer relative m-4 rounded-[1rem] overflow-hidden">
                    {cast.map((item,index)=>{
                        return (
                            <p className="my-4 flex flex-col" key={index}>
